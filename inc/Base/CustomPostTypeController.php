...
class CustomPostTypeController extends BaseController
{
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'luciano_plugin_cpt_settings',
				'option_name' => 'luciano_plugin_cpt',
	...
	{
		$options = get_option( 'luciano_plugin_cpt' ) ?: array();

...
class CustomTaxonomyController extends BaseController
{
	...
	public function setSubpages()
	{
		$this->subpages = array(
			array(
				'parent_slug' => 'luciano_plugin', 
				'page_title' => 'Custom Taxonomies', 
				'menu_title' => 'Taxonomy Manager', 
				'capability' => 'manage_options', 
				'menu_slug' => 'luciano_taxonomy', 
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'luciano_plugin_tax_settings',
				'option_name' => 'luciano_plugin_tax',
	...
	{
		$options = get_option( 'luciano_plugin_tax' ) ?: array();
